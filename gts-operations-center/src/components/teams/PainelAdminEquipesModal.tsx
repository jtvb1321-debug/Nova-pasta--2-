                          ...
                          <div key={d.id} className="flex items-center gap-3 bg-black/[0.02] border border-[#E6E1D6] rounded-lg p-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2 mb-0.5">
                                ...
                                {d.status === 'PENDENTE' && (
                                  <span className="text-xs px-2 py-0.5 rounded-full bg-amber-500/10 text-amber-700 flex items-center gap-1">
                                    <Clock className="w-3 h-3" /> Pendente
                                  </span>
                                )}
                                {d.status === 'APROVADO' && (
                                  <span className="text-xs px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-700 flex items-center gap-1">
                              ...
                              {d.status === "PENDENTE" && (
                                <>
                                  <button
                                    ...
                                    className="p-2 bg-red-500/10 hover:bg-red-500/20 border border-red-500/25 rounded-lg text-red-700 transition-colors disabled:opacity-50"
                                    title="Rejeitar"
                                  >
                                  ...
                                  <button
                                    ...
                                    disabled={revisarMutation.isPending}
                                    className="p-2 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/25 rounded-lg text-emerald-700 transition-colors disabled:opacity-50"
                                    title="Aprovar"
                                  >
