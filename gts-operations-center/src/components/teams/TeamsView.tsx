...
const STATUS_CONFIG = {
  AGUARDANDO:   { label: 'Disponivel',    cor: 'text-emerald-700', bg: 'bg-emerald-500/10 border-emerald-500/25', dot: 'bg-emerald-600' },
  DESLOCAMENTO: { label: 'Deslocamento',  cor: 'text-amber-700',   bg: 'bg-amber-500/10 border-amber-500/25',    dot: 'bg-amber-500' },
  ATIVIDADE:    { label: 'Em Atividade',  cor: 'text-amber-700',   bg: 'bg-amber-500/10 border-amber-500/25',    dot: 'bg-amber-500 animate-pulse' },
  FINALIZADO:   { label: 'Finalizado',    cor: 'text-red-700',     bg: 'bg-red-500/10 border-red-500/25',        dot: 'bg-red-600' },
}
...
function Cronometro({ inicio }: { inicio: string }) {
  ...
  return <span className="font-mono text-amber-700 font-bold">{t}</span>
}
                    ...
                    <div className="space-y-2 pt-1">
                      ...
                      <div className="flex gap-2">
                        {chamado.telefone && (
                          <button
                            ...
                            className="flex-1 flex items-center justify-center gap-1.5 px-2 py-1.5 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/25 rounded-lg text-xs font-medium text-emerald-700 transition-colors"
                          >
                        ...
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-1.5 px-2 py-1.5 bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/25 rounded-lg text-xs font-medium text-blue-700 transition-colors"
                        >
                      ...
                      {emDeslocamento && (
                        <button
                          ...
                          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-amber-500 hover:bg-amber-400 text-white font-bold rounded-lg text-sm transition-colors disabled:opacity-50"
                        >
                          {mutation.isPending
