  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-tema-superficie border border-tema-linha shadow-sm shadow-tema-contraste/[0.03] rounded-2xl w-full max-w-sm p-6 space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-9 h-9 rounded-lg bg-emerald-500/15 flex items-center justify-center">
              <CalendarPlus className="w-4.5 h-4.5 text-emerald-700" />
            </div>
            <h3 className="text-lg font-semibold text-tema-tinta">Inserir Registro de Ponto</h3>
          </div>
        ...
        <div>
          <label className="block text-xs text-tema-suave mb-1.5">Funcionario</label>
        ...
        <div>
          <label className="block text-xs text-tema-suave mb-1.5">Data</label>
