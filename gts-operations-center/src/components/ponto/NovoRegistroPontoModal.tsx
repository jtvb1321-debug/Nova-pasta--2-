      ...
      <div className="bg-white border border-[#E6E1D6] shadow-sm shadow-black/[0.03] rounded-2xl w-full max-w-sm p-6 space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-semibold text-[#201D17]">Inserir Registro de Ponto</h3>
          </div>
        ...
        <div>
          <label className="block text-xs text-[#7A7266] mb-1.5">Funcionario</label>
        ...
        <div>
          <label className="block text-xs text-[#7A7266] mb-1.5">Data</label>
