    ...
    <div className="rounded-lg border border-tema-linha bg-tema-superficie shadow-sm shadow-tema-contraste/[0.03] overflow-hidden">
      ...
      {pagination && pagination.totalPages > 1 && (
        <div className="flex items-center justify-between px-4 py-3 border-t border-tema-linha">
          <p className="text-xs text-tema-apagado font-mono">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="p-1.5 rounded-md border border-tema-linha text-tema-suave hover:text-tema-tinta hover:border-tema-linha-forte disabled:opacity-40 disabled:pointer-events-none transition-colors"
            >
