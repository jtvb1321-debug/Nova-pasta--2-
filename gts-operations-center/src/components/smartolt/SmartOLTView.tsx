          ...
          <div className="h-32 mb-3">
            <Doughnut
              ...
              options={{
                ...
                plugins: {
                  legend: { position: 'right', labels: { color: '#7A7266', font: { size: 9 }, padding: 8, boxWidth: 10 } },
                  tooltip: { backgroundColor: '#FFFFFF', borderColor: '#E6E1D6', borderWidth: 1, titleColor: '#201D17', bodyColor: '#3F3A32' },
                },
              }}
            />
          </div>
                  ...
                  <tr key={i} className="border-b border-tema-linha">
                    ...
                    <td className="py-2 text-right">
                      <button
                        ...
                        className="text-xs px-3 py-1.5 bg-orange-500/10 hover:bg-orange-500/20 border border-orange-500/20 text-orange-700 rounded-lg font-medium transition-colors"
                      >
                        Abrir Chamado
                      </button>
                    </td>
          ...
          <div className="sm:hidden space-y-2">
            {(data?.alertasSinal ?? []).map((a: any, i: number) => (
              <div key={i} className="bg-tema-contraste/[0.02] border border-tema-linha rounded-xl p-3 space-y-2">
                ...
                <button
                  onClick={() => setAlertaParaChamado(a)}
                  className="w-full text-xs px-3 py-2.5 bg-orange-500/10 hover:bg-orange-500/20 border border-orange-500/20 text-orange-700 rounded-lg font-medium transition-colors"
                >
                  Abrir Chamado
                </button>
              </div>
