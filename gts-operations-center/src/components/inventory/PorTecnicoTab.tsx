                ...
                <>
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="text-xs text-orange-700 hover:text-orange-800 bg-orange-500/10 hover:bg-orange-500/20 border border-orange-500/25 rounded-lg px-3 py-1.5 transition-colors"
                    >
                      Adicionar
                    </button>
                  </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {!estaBaixando && (
                          <button
                            ...
                            className="flex items-center gap-1 text-xs text-emerald-700 hover:text-emerald-800 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/25 rounded-lg px-2.5 py-1.5 transition-colors"
                          >
